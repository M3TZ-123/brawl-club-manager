...
function AdminPanel({ onLogout }: { onLogout: () => Promise<void> }) {
  return <LayoutWrapper><div className="mx-auto max-w-5xl space-y-6">
    ...
    <div className="grid gap-4 sm:grid-cols-2">
      <Card className="border-primary/40"><CardContent className="p-5"><Link href="/reviews" className="flex items-center gap-3 hover:text-primary"><ClipboardList className="h-5 w-5" /><div><p className="font-semibold"><T text="Notes and departure reasons" /></p><p className="mt-1 text-sm text-muted-foreground"><T text="Notes and follow-ups for your members." /></p></div></Link></CardContent></Card>
