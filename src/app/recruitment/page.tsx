...
function RecruitmentWorkspace({initialComparison}:{initialComparison?:ComparisonSelection}={}) {
  ...
  return <div className="space-y-5">
    <header><h1 className="text-3xl font-bold flex gap-3 items-center"><UserPlus className="text-primary" />{t("Recruitment")}</h1></header>
