...
export default function JoinPage(){
  ...
  return <LayoutWrapper><div className="mx-auto max-w-2xl space-y-5"><header><h1 className="text-2xl font-bold">{t("Apply to join the club")}</h1></header>
    ...
    <details className="text-sm text-muted-foreground"><summary className="cursor-pointer">{t("How applications work")}</summary><div className="mt-2 space-y-2"><p>{t("Submitting a request does not verify account ownership or send an invitation.")}</p><p>{t("Rejected or archived applications may be removed after 90 days.")}</p></div></details>
  </div></LayoutWrapper>;
}
