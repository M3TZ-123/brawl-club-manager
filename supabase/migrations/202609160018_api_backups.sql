-- Include ranked fallback attempts and the compact public sync signal in restorable backups.
BEGIN;
...
DECLARE
  v_allowed text[] := ARRAY['members','activity_log','club_events','member_history','settings','battle_history','player_tracking','brawler_snapshots','daily_stats','notifications','profiles','clubs','user_clubs','sync_runs','sync_leases','membership_change_events','notification_outbox','member_activity_state','player_brawler_state','member_reviews','admin_login_attempts','backup_snapshots','backup_chunks','sync_battle_coverage','sync_battle_gaps','capacity_samples','sync_ranked_fallback_attempts','club_sync_signals'];
